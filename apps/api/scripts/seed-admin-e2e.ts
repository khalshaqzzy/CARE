  ...
  try {
    ...
    const generalVoice = await prisma.voice.create({
      data: {
        ...
        reporterNoRegSnapshot: '00000128',
        ...
        handlingOrganizationUnitId: unitA.id,
        handlingDirectorateSnapshot: unitA.directorate,
        handlingDivisionSnapshot: unitA.division,
        handlingDepartmentSnapshot: unitA.department,
    ...
    await prisma.importChange.create({
      data: {
        ...
        type: 'CREATE',
        noReg: '00000128',
        payload: { type: 'CREATE', noReg: '00000128' },
      },
    });
