...
const queryParameters: Record<string, string[]> = {
  ...
  VoicesController_adminHandoverQueue: ['cursor', 'limit'],
...
function successSchema(operationId: string) {
  ...
  const mapping: Record<string, string> = {
    ...
    VoicesController_adminHandoverDetail: 'AdminHandoverDetail',
    VoicesController_adminHandoverOptions: 'AdminHandoverOptions',
    VoicesController_adminHandoversForVoice: 'AdminHandoverHistory',
    VoicesController_resolveAdminHandover: 'VoiceMutationResponse',
    VoicesController_returnAdminHandover: 'VoiceMutationResponse',
    ...
    VoicesController_listMine: 'VoiceListResponse',
...
function requestSchema(operationId: string) {
  const mapping: Record<string, string> = {
    ...
    VoicesController_returnAdminHandover: 'AdminHandoverNoteRequest',
...
const schemas: Record<string, any> = {
  ...
  AdminHandoverNoteRequest: {
    type: 'object',
    required: ['detail', 'expectedVersion'],
    additionalProperties: false,
    properties: {
      detail: { type: 'string', minLength: 1, maxLength: 4000 },
      expectedVersion: { type: 'integer', minimum: 1 },
  ...
  AdminHandoverDecisionRequest: {
    type: 'object',
    required: ['organizationUnitId', 'detail', 'expectedVersion'],
    additionalProperties: false,
    properties: {
      organizationUnitId: { type: 'string', format: 'uuid' },
      categoryId: { type: 'string', format: 'uuid' },
      customCategory: { type: 'string', minLength: 1, maxLength: 160 },
      detail: { type: 'string', minLength: 1, maxLength: 4000 },
      expectedVersion: { type: 'integer', minimum: 1 },
    },
  },
  AdminHandoverQueue: {
    ...
    properties: {
      items: {
        ...
        items: {
          type: 'object',
          required: ['id', 'createdAt', 'manager', 'managerDetail', 'voice'],
          properties: {
            id: { type: 'string', format: 'uuid' },
            ...
            voice: {
              ...
              properties: {
                ...
                version: { type: 'integer' },
                categoryNameSnapshot: { type: 'string', nullable: true },
                currentCategoryNameSnapshot: { type: 'string', nullable: true },
                area: { type: 'string' },
              },
            },
          },
  ...
  AdminHandoverDetail: {
    type: 'object',
    required: ['id', 'status', 'createdAt', 'manager', 'managerDetail', 'adminDetail', 'voice'],
    additionalProperties: false,
    properties: {
      id: { type: 'string', format: 'uuid' },
      status: { type: 'string' },
      ...
      managerDetail: { type: 'string' },
      adminDetail: { type: 'string', nullable: true },
      voice: {
        type: 'object',
        required: [
          'id',
  ...
  AdminHandoverOptions: {
    type: 'object',
    required: ['currentCategoryId', 'items'],
    additionalProperties: false,
    properties: {
      currentCategoryId: { type: 'string', format: 'uuid', nullable: true },
      items: {
        type: 'array',
        items: {
          type: 'object',
