...
Status: `in_progress` — subphases 8.0–8.5 sequential; only one subphase may be `in_progress`.
...
- Phase 9 tidak dimulai sebelum gate passed; production containerization tetap out of scope.
