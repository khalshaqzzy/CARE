...
| Last updated           | 9 September 2026 (organization-dashboard transaction acquisition stabilization; ADR-0042)                                                                                                                                                                                                                                 |
| Product contract       | `.agent/PRD.md` v1.1                                                                                                                                                                                                                                                                                                      |
| Current implementation | Organization dashboard repeatable-read transactions use explicit 5-second acquisition/execution limits while retaining the 3-second p95 gate; full local quality/deployment/container parity passed except the user-deferred local Trivy download, which remains mandatory in hosted CI. Hosted PR acceptance is pending. |
