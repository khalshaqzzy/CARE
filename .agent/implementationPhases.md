...
| Last updated           | 7 September 2026 (dashboard scope consistency and completed local delivery parity; ADR-0042 amendment)                                                                                                                                                                                                                            |
| Product contract       | `.agent/PRD.md` v1.1                                                                                                                                                                                                                                                                                                              |
| Current implementation | Dashboard scope restoration, hierarchical selection restrictions, repeatable-read aggregates and Jakarta refresh are implemented; local integration, security, browser, full-stack and performance validation passed; canonical visual verification passed on darwin and Linux x64. Phase 13 hosted acceptance remains unchanged. |
